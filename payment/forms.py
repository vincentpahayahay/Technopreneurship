...
class ShippingForm(forms.ModelForm):
    ...
    shipping_barangay = forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Barangay'}), required=False)
    ...
    class Meta:
        ...
        fields = ['shipping_full_name', 'shipping_email', 'shipping_address1', 'shipping_address2', 'shipping_city', 'shipping_barangay', 'shipping_zipcode', 'shipping_country']
...
class PaymentForm(forms.Form):
    ...
    card_barangay =forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control', 'placeholder':'Billing Barangay'}), required=True)
